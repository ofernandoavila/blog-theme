...
export const get_post = (slug:string): Promise<Post> => api.get<PostDTO>('/wp/v2/posts', { params: { slug: slug, _embed: "wp:featuredmedia,author,wp:term" } }).then( response => MapPost(response.data) );
